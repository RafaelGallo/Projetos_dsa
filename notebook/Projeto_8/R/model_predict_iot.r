...
# Conclusão
# O melhor modelo que produziu resultados significativamente satisfatórios foi a Regressão Linear Múltipla.
# Em seguida, aplicamos o Modelo de Série Temporal ARIMA, que também obteve um desempenho notável, alcançando um coeficiente de determinação (R2) muito satisfatório.
# Esses modelos nos proporcionaram uma visão clara e precisa das previsões de energia, permitindo-nos analisar e interpretar os resultados com confiança.
# É importante destacar que a combinação desses dois modelos demonstrou ser especialmente eficaz na previsão de demanda de energia.

# Referência
# Link 1: https://statplace.com.br/blog/regressao-logistica-multinomial/
# Link 2: https://www.monolitonimbus.com.br/modelo-arima-e-previsao-no-r/
